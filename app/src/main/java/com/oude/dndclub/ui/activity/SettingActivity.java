...
public class SettingActivity extends AppCompatPreferenceActivity {
    ...
    public static class GeneralPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            bindPreferenceSummaryToValue(findPreference("local_path"));
        }
    ...
    public static class DatabasePreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            bindPreferenceSummaryToValue(findPreference("mysql_ip"));
            bindPreferenceSummaryToValue(findPreference("mysql_username"));
            bindPreferenceSummaryToValue(findPreference("mysql_pwd"));
        }
